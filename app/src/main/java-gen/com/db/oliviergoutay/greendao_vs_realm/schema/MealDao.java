    ...
    */
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getMealPhotoDao().getAllColumns());
            builder.append(" FROM MEAL T");
            builder.append(" LEFT JOIN MEAL_PHOTO T0 ON T.\"PHOTO_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected Meal loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        MealPhoto mealPhoto = loadCurrentOther(daoSession.getMealPhotoDao(), cursor, offset);
        entity.setMealPhoto(mealPhoto);
