...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        DailyMealDao.createTable(db, ifNotExists);
        MealDao.createTable(db, ifNotExists);
        MealPhotoDao.createTable(db, ifNotExists);
        MealItemDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        DailyMealDao.dropTable(db, ifExists);
        MealDao.dropTable(db, ifExists);
        MealPhotoDao.dropTable(db, ifExists);
        MealItemDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(DailyMealDao.class);
        registerDaoClass(MealDao.class);
        registerDaoClass(MealPhotoDao.class);
        registerDaoClass(MealItemDao.class);
    }
